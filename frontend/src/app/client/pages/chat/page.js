                    ...
                    <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                      <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                        <img
                          ...
                          srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-03.png&w=48&q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-03.png&w=96&q=75 2x"
                          src="/_next/image?url=%2Fimages%2Fuser%2Fuser-03.png&w=96&q=75"
                    ...
                    <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                      <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                        <img
                          ...
                          data-nimg={1}
                          className="h-full w-full object-cover object-center"
                          srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-04.png&w=48&q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-04.png&w=96&q=75 2x"
                          src="/_next/image?url=%2Fimages%2Fuser%2Fuser-04.png&w=96&q=75"
                          style={{ color: "transparent" }}
                        />
                        <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 bg-success" />
                      </div>
                    ...
                    <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                      <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                        <img
                          ...
                          data-nimg={1}
                          className="h-full w-full object-cover object-center"
                          srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-05.png&w=48&q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-05.png&w=96&q=75 2x"
                          src="/_next/image?url=%2Fimages%2Fuser%2Fuser-05.png&w=96&q=75"
                          style={{ color: "transparent" }}
                        />
                        <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 bg-success" />
                      </div>
                    ...
                    <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                      <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                        <img
                          ...
                          data-nimg={1}
                          className="h-full w-full object-cover object-center"
                          srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-01.png&w=48&q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-01.png&w=96&q=75 2x"
                          src="/_next/image?url=%2Fimages%2Fuser%2Fuser-01.png&w=96&q=75"
                          style={{ color: "transparent" }}
                        />
                        <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 bg-success" />
                      </div>
                    ...
                    <div className="flex cursor-pointer items-center rounded px-4 py-2 hover:bg-gray-2 dark:hover:bg-strokedark">
                      <div className="relative mr-3.5 h-11 w-full max-w-11 rounded-full">
                        <img
                          ...
                          data-nimg={1}
                          className="h-full w-full object-cover object-center"
                          srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-02.png&w=48&q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-02.png&w=96&q=75 2x"
                          src="/_next/image?url=%2Fimages%2Fuser%2Fuser-02.png&w=96&q=75"
                          style={{ color: "transparent" }}
                        />
                        <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full border-2 border-gray-2 bg-success" />
                      </div>
                  ...
                  <div className="flex items-center">
                    <div className="mr-4.5 h-13 w-full max-w-13 overflow-hidden rounded-full">
                      <img
                        ...
                        data-nimg={1}
                        className="h-full w-full object-cover object-center"
                        srcSet="/_next/image?url=%2Fimages%2Fuser%2Fuser-01.png&w=64&q=75 1x, /_next/image?url=%2Fimages%2Fuser%2Fuser-01.png&w=128&q=75 2x"
                        src="/_next/image?url=%2Fimages%2Fuser%2Fuser-01.png&w=128&q=75"
                        style={{ color: "transparent" }}
                      />
                    </div>
                    <div>
