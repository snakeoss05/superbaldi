        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-6 max-w-md text-center leading-relaxed text-gray-600 sm:max-w-xs sm:text-left">
              Super Baldi is a shopwith state-of-the-art technology
            </p>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            ...
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-gray-800">Our Services</p>
            ...
            <div className="text-center sm:text-left">
              <p className="text-lg font-medium text-gray-800">Helpful Links</p>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  <a
                    ...
                    <span className="flex-1 text-gray-600">27768325</span>
                  </a>
                </li>
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 not-italic text-gray-600">
                    48, Rue el tattawer Cite tahrir, Tunis, Tunisia
                  </address>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 border-t border-gray-100 pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm text-gray-500">
              ...
              <a
                className="inline-block text-gray-500 underline transition hover:text-teal-600/75"
                href="#">
                Terms & Conditions
              </a>
