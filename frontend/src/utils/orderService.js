...
export const getOrdersById = async (orderId, page) => {
  try {
    const response = await fetch(
      `http://192.168.1.3:5000/api/orders/${orderId}?page=${page}&limit=8`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const DeleteOrder = async (orderId) => {
  try {
    const response = await fetch(
      `http://192.168.1.3:5000/api/orders/${orderId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
export const getOrdersProducts = async (orderId) => {
  try {
    const response = await fetch(
      `http://192.168.1.3:5000/api/orders/getOrderProducts/${orderId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const getOrdersByOderId = async (orderId) => {
  try {
    const response = await fetch(
      `http://192.168.1.3:5000/api/orders/getOrderByOderId/${orderId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const getOrders = async (page, orderDate, status) => {
  try {
    const response = await fetch(
      `http://192.168.1.3:5000/api/orders?page=${page}&limit=8&orderDate=${orderDate}&status=${status}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const generateInvoice = async (orderId) => {
  try {
    const response = await fetch(
      `http://192.168.1.3:5000/api/orders/generateInvoice/${orderId}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const updateOrderItems = async (orderId, orderItems) => {
  try {
    const response = await fetch(
      `http://192.168.1.3:5000/api/orders/${orderId}/items`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
